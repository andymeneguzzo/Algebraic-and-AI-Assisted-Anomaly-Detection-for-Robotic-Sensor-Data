...
import pandas as pd
from src import preprocessing, residual_detector, covariance_detector
...
def main():
    ...
    parser.add_argument("--stage", type=str, required=True,
                        choices=["preprocess", "detect"], help="Pipeline stage to execute.")
    ...
    if args.stage == "preprocess":
        ...
        print("Unknown stage. Available: preprocess, detect")
